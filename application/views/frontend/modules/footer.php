    ...
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                <a href="trang-chu">
                    <img src="public/images/linh-lee1.png" style="width: 90%;" class="img-fix f-logo" alt="smart-construction">
                </a>
            ...
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="clearfix">
                        ...
                        <span>Hot line : 096 127 0500</span>                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:hotro@dochoihailinh.vn">hotro@dochoihailinh.vn</a></span>                    </li>
                </ul>
            </div>
        </div>
    </div>
